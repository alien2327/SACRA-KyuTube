...
if __name__ == "__main__":   
    ...
    while True:
        ...
        cur_url = "https://www.sci.kyoto-u.ac.jp/en/admin/contents/?pageno=5&parentcode=2287"
        driver.get(cur_url)
        k = 8
        for i, (j, d) in enumerate(filtered_data.iterrows()):
            ...
            if len(code) > 6:
                ...
                btn = driver.find_element_by_xpath(f"//*[@id=\"container\"]/table/tbody/tr[{k}]/td[7]/input[2]")
                btn.click()
                for c in codes:
